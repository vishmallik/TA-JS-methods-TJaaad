...
*/
console.log(`Th index of first is in quote is ${indexOfIs}`);
/*
...
*/
quoteSplitted = quoteSplitted.map((element) => {
  if (element === "today") {
    return "tomorrow";
  } else {
    return element;
...
*/
paddedEndQuotes = quote.padEnd(70, ".");
console.log(paddedEndQuotes);
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
paddedStartQuotes = quote.padStart(70, ".");
console.log(paddedStartQuotes);
/*
